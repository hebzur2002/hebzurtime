        ...
        <button
          ...
          onClick={async () => {
            ...
            if (result !== "granted") {
              alert(
                result === "unsupported"
                  ? "Is browser mein push notifications supported nahi hain."
                  : "Permission not granted — check browser site settings."
              );
              return;
            }
            ...
            if (!res.ok) alert("Test push bhejne mein error aaya.");
          }}
        >
